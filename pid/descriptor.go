...
import (
	d "machine/usb/descriptor"
	"machine/usb/hid/joystick"
)

var Definitions = joystick.Definitions{
	ReportID:     1,
	ButtonCnt:    16,
	HatSwitchCnt: 1,
...
//go:align 4
var Descriptor = d.Append([][]byte{
	d.HIDUsagePageGenericDesktop,
	d.HIDUsageDesktopJoystick,
	d.HIDCollectionApplication,
	d.HIDReportID(1),
	d.HIDCollectionPhysical,

	d.HIDUsagePageButton,
	d.HIDUsageMinimum(1),
	d.HIDUsageMaximum(16),
	d.HIDLogicalMinimum(0),
	d.HIDLogicalMaximum(1),
	d.HIDReportSize(1),
	d.HIDReportCount(16),
	d.HIDUnitExponent(0),
	d.HIDUnit(0),
	...
	d.HIDUsagePageGenericDesktop,
	d.HIDUsageDesktopHatSwitch,
	d.HIDLogicalMinimum(0),
	d.HIDLogicalMaximum(7),
	d.HIDPhysicalMinimum(0),
	d.HIDPhysicalMaximum(315),
	d.HIDUnit(0x14),
	d.HIDReportCount(1),
	d.HIDReportSize(4),
	d.HIDInputDataVarAbs,
